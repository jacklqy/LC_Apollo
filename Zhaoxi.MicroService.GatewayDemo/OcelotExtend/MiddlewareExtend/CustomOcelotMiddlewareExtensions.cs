...
{
    /// <summary>
    /// 照抄https://github.com/ThreeMammals/Ocelot/blob/fe3e8bd23a666daa31ed2e8b00dce2c4630c23a7/src/Ocelot/Middleware/OcelotMiddlewareExtensions.cs
    /// 扩展下
    /// </summary>
    public static class CustomOcelotMiddlewareExtensions
    {
        public static async Task<IApplicationBuilder> UseOcelotEleven(this IApplicationBuilder builder)
        {
            await builder.UseOcelotEleven(new OcelotPipelineConfiguration());
            return builder;
        }

        public static async Task<IApplicationBuilder> UseOcelotEleven(this IApplicationBuilder builder, Action<OcelotPipelineConfiguration> pipelineConfiguration)
        {
            var config = new OcelotPipelineConfiguration();
            pipelineConfiguration?.Invoke(config);
            return await builder.UseOcelotEleven(config);
        }

        public static async Task<IApplicationBuilder> UseOcelotEleven(this IApplicationBuilder builder, OcelotPipelineConfiguration pipelineConfiguration)
        {
        ...
        public static Task<IApplicationBuilder> UseOcelotEleven(this IApplicationBuilder app, Action<IApplicationBuilder, OcelotPipelineConfiguration> builderAction)
            => UseOcelotEleven(app, builderAction, new OcelotPipelineConfiguration());

        public static async Task<IApplicationBuilder> UseOcelotEleven(this IApplicationBuilder app, Action<IApplicationBuilder, OcelotPipelineConfiguration> builderAction, OcelotPipelineConfiguration configuration)
        {
